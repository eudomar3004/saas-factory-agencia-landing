...
### 👁️ Playwright MCP - Tus Ojos (Browser Automation)
Automatización de navegador con API completa de Playwright. Control total sobre interacciones web.

**Comandos disponibles:**
```
playwright_navigate → Navegar a URL
playwright_screenshot → Capturar pantalla
playwright_click → Click en elemento (selector CSS)
playwright_fill → Llenar input/textarea
playwright_select → Seleccionar dropdown
playwright_hover → Hover sobre elemento
playwright_evaluate → Ejecutar JavaScript en página
```

**Ventajas:**
- API completa de Playwright desde Claude
- Control total del navegador (click, fill, evaluate JS)
- Screenshots para validación visual
- Soporte para selectors CSS, XPath, texto
